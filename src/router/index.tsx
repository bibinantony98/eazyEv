...
export const Router = () => {
	...
	if (localStorage.getItem(StoredKeys.USER_DETAILS) && !userReducer.userDetails.token) {
	...
	if ((storedData && Object.keys(JSON.parse(storedData)).length) || userReducer.userDetails.token) {
		return (
			<Routes>
